...
public class StAXTariffBuilderTest {
  private static final StAXTariffBuilder stAXTariffBuilder = new StAXTariffBuilder();
  ...
  public void shouldReturnValidInformation() throws IOServiceException, XMLParserServiceException {
    List<Tariff> tariffList = stAXTariffBuilder.build(new XMLValidatorByXSD(PATH_TO_XSD),"resources/xml/tariffs_one.xml");
  ...
  public void allEntitiesShouldBeEqual() throws IOServiceException, XMLParserServiceException {
    ...
    List<Tariff> tariffListFromFile = stAXTariffBuilder.build(new XMLValidatorByXSD(PATH_TO_XSD),"resources/xml/tariffs_four.xml");
  ...
  public void shouldThrowExceptionIfFileNotValid()
    ...
    stAXTariffBuilder.build(new XMLValidatorByXSD(PATH_TO_XSD),"resources/xml/tariffs_five.xml");
  }

  @Test
  public void shouldReturnEmptyCollection() throws IOServiceException, XMLParserServiceException {
    List<Tariff> tariffListFromFile = stAXTariffBuilder.build(new XMLValidatorByXSD(PATH_TO_XSD),"resources/xml/tariff_three.xml");
  ...
  public void shouldTrimAllStrings() throws IOServiceException, XMLParserServiceException {
    List<Tariff> tariffListFromFile = stAXTariffBuilder.build(new XMLValidatorByXSD(PATH_TO_XSD),"resources/xml/tariffs_two.xml");
