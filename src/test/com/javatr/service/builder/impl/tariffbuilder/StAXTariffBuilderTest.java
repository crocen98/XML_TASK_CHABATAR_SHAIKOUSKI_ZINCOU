...
public class StAXTariffBuilderTest {
  ...
  public void allEntitiesShouldBeEqual() throws IOServiceException, XMLParserServiceException {
    ...
    List<Tariff> tariffListFromFile = stAXTariffBuilder.build(new XMLValidatorByXSD(pathToXSD),"resources/xml/tariffs_four.xml");
  ...
  public void shouldThrowExceptionIfFileNotValid()
    ...
    List<Tariff> tariffListFromFile = stAXTariffBuilder.build(new XMLValidatorByXSD(pathToXSD),"resources/xml/tariffs_five.xml");
  }

  @Test
  public void shouldReturnEmptyCollection() throws IOServiceException, XMLParserServiceException {
    List<Tariff> tariffListFromFile = stAXTariffBuilder.build(new XMLValidatorByXSD(pathToXSD),"resources/xml/tariff_three.xml");
